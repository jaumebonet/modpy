...
# @last modified time: 2015-05-08 17:44:54
#
# -*-
'''
...
def set_options(*args, **kargs):
    ...
    parser.add_option("--models", dest="numMod", action="store",
...
def simple_model(alignment, instances, optimize=False, verbose=False):
    ...
    a = automodel(env,  # Loading the environment
                  ...
                  assess_methods=(assess.DOPE,
                                  assess.GA341))  # Energy evaluation methods
